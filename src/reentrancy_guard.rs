...
pub fn reentrancy_guard_from_package_name(package_name: impl AsRef<str>) -> String {
    format!(
        "NESTED_WORKSPACE_REENTRANCY_GUARD_{}",
        package_name.as_ref()
    )
}
...
pub fn dependent_from_package_name(package_name: impl AsRef<str>) -> String {
    format!("NESTED_WORKSPACE_DEPENDENT_{}", package_name.as_ref())
}
